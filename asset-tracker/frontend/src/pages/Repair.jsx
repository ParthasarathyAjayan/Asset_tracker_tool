...
export default function Repair() {
  ...
  if (isLoading) {
    return (
      <div className="page">
        <h2 className="text-4xl font-bold text-white mb-2">Repair List</h2>
        <LoadingSpinner />
      </div>
    );
  }
  ...
  return (
    <div className="page">
      ...
      <div className="mb-8">
        <h2 className="text-4xl font-bold text-white mb-2">Repair List</h2>
        <p className="text-white font-medium">Track all assets currently in repair</p>
      </div>
      ...
      <Card className="mb-8 bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-orange-500">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <p className="text-white text-sm font-bold">Total in Repair</p>
            <p className="text-3xl font-bold text-orange-400">{items.length}</p>
          </div>
          <div>
          ...
          <div>
            <p className="text-white text-sm font-bold">Last Updated</p>
          ...
          {items.map(a => (
            <Card key={a.asset_code} className="border-l-4 border-orange-500">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h3 className="text-xl font-bold text-orange-400">{a.asset_code}</h3>
                  <p className="text-sm text-white font-medium mt-1">Asset Code</p>
                </div>
              ...
              <div className="space-y-3 bg-gray-50 rounded-lg p-4">
                <div>
                  <p className="text-sm font-bold text-gray-900">Assigned Technician</p>
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900">Repair Start Date</p>
                ...
                <div className="pt-2 border-t-2 border-orange-500">
